...
// Марина, спасибо за ревью.
// На всякий случай уточню, в задании уже был исходный код,
// поэтому написал только ту часть, что требовалась по заданию.
// Все комментарии были к исходному коду, их проработал, тесты проверил с использованием sanitizers.
